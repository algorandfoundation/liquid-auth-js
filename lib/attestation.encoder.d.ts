 ...
 */
export declare function encodeCredential(credential: PublicKeyCredential): EncodedAttestationCredential;
/**
 ...
 */
export declare function decodeOptions(options: any, liquidOptions: any): any;
